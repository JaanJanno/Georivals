...
/**
 * Class for making a HTTP post request to the server and retrieving a
...
public abstract class GenericObjectPostLoader<T> extends GenericObjectLoader<T> {
	...
	/**
	 * 
	 * @param typeParameterClass Type of the response.
	 * @param post The object to be posted to the server.
	 * @param url Url of the request.
	 */
	
	public GenericObjectPostLoader(Class<T> typeParameterClass, Object post, String url) {
