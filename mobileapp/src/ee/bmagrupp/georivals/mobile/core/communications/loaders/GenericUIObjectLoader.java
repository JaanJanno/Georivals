 ...
 * object parsed from JSON and handling it on UI. To define the class of the
 * object to be retrieved put its class name in the <> brackets and pass its
 * class as the first argument to the constructor. Use this by overriding the
 * handleResponseList() method and calling retrieveObject() method.
 * 
 * @author Jaan Janno
 */
...
abstract public class GenericUIObjectLoader<T> extends GenericObjectLoader<T> {
	 ...
	 * @param activity
	 *            The activity that executes handleResponseObjectOnUI
	 * @param url
	 * @param cookie
	 */

	public GenericUIObjectLoader(Class<T> typeParameterClass,
			Activity activity, String url, String cookie) {
	 ...
	 * retrieved. This runs on the UI thread.
	 */
