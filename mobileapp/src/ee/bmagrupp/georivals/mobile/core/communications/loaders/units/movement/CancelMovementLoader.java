 ...
 * 
 * Response can be handled by overriding the handleResponseObject() method.
 * 
 * @author Jaan Janno
 * 
 */
...
public abstract class CancelMovementLoader extends
		GenericObjectLoader<MovementViewDTO> {
	 ...
	 * objects gotten from server. (Units moving back to origin)
	 */
