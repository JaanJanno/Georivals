...
/**
 * Class for canceling a movement from server. Able 
 * to handle response straight on UI. Use this by overriding the 
 * response handling methods and calling retrieveObject() method.
 * @author	Jaan Janno
 */
...
public abstract class CancelMovementUILoader extends CancelMovementLoader {
	...
	/**
	 * 
	 * @param sid User identifier sent in cookie.
	 * @param movementId Id of movement to be deleted.
	 * @param activity Android activity that is modified.
	 */
	...
	abstract public void handleResponseObjectInBackground(MovementViewDTO responseObject);
