...
/**
 * Class for sending a GET request to receive a list of an users
 * movements in progress. User is identified by sid added in cookie.
 * 
 * Response  list can be handled by overriding the 
 * handleResponseList() method.
 * 
 * @author Jaan Janno
 */

public abstract class MovementViewLoader extends GenericListLoader<MovementViewDTO> {
