...
/**
 * Class for retrieving MovementViewDTO lists from server. Able 
...
public abstract class MovementViewUILoader extends MovementViewLoader {
	...
	abstract public void handleResponseListInUI(List<MovementViewDTO> responseList);
	...
	abstract public void handleResponseListInBackground(List<MovementViewDTO> responseList);
