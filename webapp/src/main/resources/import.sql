INSERT INTO user (`id`,`username`,`email`) VALUES (1,'aabits','aabits@a.ee');
INSERT INTO user (`id`,`username`,`email`) VALUES (2,'heio','heio@a.ee');
INSERT INTO treasure (`id`,`latitude`,`longitude`,`picture_link`) VALUES (1,55.34,24.12,'http://codepump2.herokuapp.com');
INSERT INTO treasure (`id`,`latitude`,`longitude`,`picture_link`) VALUES (2,58.30,26.00,'http://tribal-age.herokuapp.com');
